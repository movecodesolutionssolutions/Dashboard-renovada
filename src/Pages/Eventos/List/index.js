            ...
            {isModalOpen && (
                <div style={{
                    ...
                    <div style={{background: '#fff', padding: '20px', borderRadius: '8px'}}>
                            ...
                            <div class="flex flex-wrap -mx-3 mb-6">
                                <div class="w-full md:w-full px-3 mb-6 md:mb-0">
                                    ...
                                    <input
                                        ...
                                        id="grid-first-name" type="text" placeholder="Nome do Evento"></input>
                                </div>
                            </div>
                            <div class="flex flex-wrap -mx-3 mb-6">
                            ...
                            <div class="flex flex-wrap -mx-3 mb-2">
                                <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                                    ...
                                    <input
                                        ...
                                        id="grid-city" type="text" placeholder="Albuquerque"></input>
                                </div>
                                <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                                           for="grid-state">
                                ...
                                <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                                    ...
                                    <input
                                        class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                        id="grid-zip" type="text" placeholder="90210"></input>
                                </div>
                                <div className="w-full md:w-full px-3 mb-6 md:mb-0 my-6">
                                    ...
                                    <input
                                        ...
                                        id="grid-first-name" type="date"></input>
                                </div>
                                <div className="w-full md:w-full px-3 mb-6 md:mb-0 my-6">
                        ...
                        <button class="mt-5" onClick={handleCloseModal}>Fechar</button>
                    </div>
                </div>
            )}
        </>
